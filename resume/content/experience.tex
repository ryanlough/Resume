  ...
  \cventry
    ...
    {Jan. 2016 - June 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Updated the marketing suite to support contact based workflows, saving the company and customers thousands of dollars and hours of onboarding time and money}
        \item {Improved performance and experience of current screens up to a 95\% increase in speed and 99.9\% reduction in memory usage}
